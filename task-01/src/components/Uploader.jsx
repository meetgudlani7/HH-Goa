 ...
 * - File size warnings
 */
export const Uploader = ({ setStep, processImage }) => {
  ...
  const handleFileSelect = useCallback(
    ...
    [processImage, setStep, formatFileSize]
  );
  ...
  return (
    <div className="hero" ref={dragDropRef}>
      ...
      <div className="pbt-hacker poster-bg-text">
        HACK
        <br />
        HACK
      </div>
      ...
      {/* Decorative SVG: palm tree, bottom right, sitting behind the ticker */}
      <svg
        className="hero-palm-deco"
        viewBox="0 0 140 160"
        fill="none"
        xmlns="http://www.w3.org/2000/svg"
        aria-hidden="true"
      >
        ...
        />
        <circle cx="64" cy="66" r="6" fill="#A83210" opacity=".8" />
        <circle cx="76" cy="70" r="6" fill="#A83210" opacity=".8" />
      </svg>
      ...
      <div className="hero-body">
        ...
        <div className="hero-annotation">
          ...
          <div
            className="anno-pill"
            style={{ background: 'var(--pink)', transform: 'rotate(1.5deg)' }}
          >
            ★ BUILT IN GOA ★
          </div>
        </div>
        ...
        <div className="diagonal-band">
          <div className="diagonal-band-text">
            // हैकर हाउस में आपका स्वागत है · welcome, builder
          </div>
        </div>
        ...
        <div className="poster-headline">
          ...
          HOUSE
          <br />
          <span className="accent-pink">GOA</span>
          <span
          ...
          >
            ...
            {isProcessing ? (
              ...
              >
                ...
                >
                  {fileInfo?.name
                    ? `Converting ${fileInfo.name}...`
                    : 'Converting your iPhone photo...'}
                </p>
              </div>
            ) : (
              <>
        ...
        <div className="hero-note-row">
          <div className="hero-note-text">🥥 BEST ENJOYED NEAR THE ARABIAN SEA</div>
          <div className="hero-note-divider"></div>
          <div className="hero-note-text">BUILT IN GOA · MADE TO SHIP</div>
        </div>
      </div>
      ...
      <div className="ticker-shell">
        <div className="ticker-outer">
          <span className="ticker-inner">
            🌊 JUGAAD KARO · SHIP KARO · REPEAT 🌴 GOA COMPATIBILITY: 100% 🥥 247 BUILDERS FROM
            20,500+ APPLICANTS ★ $50K+ BOUNTIES 🌺 PRIVATE BEACH RESORT 🐚 AI × CRYPTO 🛵 WORKS ON
            MY MACHINE ⚡ COFFEE: CRITICAL ✦ JUGAAD KARO · SHIP KARO · REPEAT 🌊 GOA COMPATIBILITY:
            100% 🌴 247 BUILDERS ★ $50K+ BOUNTIES 🥥 PRIVATE BEACH RESORT 🛵 AI × CRYPTO 🌺 WORKS ON
            MY MACHINE ⚡
          </span>
        </div>
        ...
        <div className="hero-info-row">
          ...
          <span className="info-chip">
            <strong>28–31 OCTOBER · GOA, INDIA</strong>
          </span>
      ...
      {fileSizeWarning && !error && (
        <div
          style={{
            background: 'rgba(240,194,41,.15)',
            border: '1px solid rgba(240,194,41,.3)',
            padding: '10px',
            display: 'flex',
            alignItems: 'center',
            justifyContent: 'center',
